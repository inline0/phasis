...
// AUTO-GENERATED from test262/test/staging/sm/String/string-upper-lower-mapping.js
// (Unicode 16.0.0 case mappings for BMP). Used by StringPrototype to
// guarantee host-independent Unicode 16 toUpperCase / toLowerCase results.
 ...
 * generated test262 fixture. ICU on Ubuntu CI (ICU 74) and even macOS
 * (ICU 78) lag the latest Unicode case-pair additions, so we bundle the
 * authoritative tables and apply them per-codepoint inside
 * StringPrototype::toUpperCase / toLowerCase.
 *
 * Each entry maps a BMP codepoint to an array of result codepoints
 * (multi-codepoint expansions like 0x00DF -> [0x53, 0x53] are encoded
 * directly). Codepoints whose mapping equals themselves are omitted.
 */
final class UnicodeCaseTables
{
