...
- Snapshot time: `2026-04-27T13:25:45+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `682c3ed` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47834 | 95 | 2083 | 24 | 882 | 0 | 47929 | 50036 | 50918 | 99.8% |
...
| language | INCOMPLETE | 22460 | 7 | 902 | 4 | 61 | 0 | 100.0% |
...
| language/statements | PARTIAL | 9123 | 3 | 28 | 0 | 0 | 0 | 100.0% |
...
|---|---|---:|---:|---|
| intl402 | NORMAL | 61.988s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | CRASH | 61.833s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| staging/sm | CRASH | 61.579s | 1 | `test262/test/staging/sm/TypedArray/sort_small.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.520s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| staging/sm | CRASH | 61.518s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.155s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| language/literals | CRASH | 61.007s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.1_T2.js` |
| staging/sm | CRASH | 60.973s | 1 | `test262/test/staging/sm/expressions/nullish-coalescing.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.900s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.667s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 60.371s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
| staging/sm | CRASH | 60.369s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| staging/sm | CRASH | 59.980s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| language/literals | CRASH | 59.865s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.1_T2.js` |
| language/literals | CRASH | 59.791s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.4_T2.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 59.737s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 59.566s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| language/literals | CRASH | 59.345s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.4_T2.js` |
| staging/sm | NORMAL | 56.117s | 13 | `test262/test/staging/sm/Temporal/PlainDate/from-constrain-hebrew.js`<br>`test262/test/staging/sm/Temporal/PlainDate/from-constrain-japanese.js`<br>...<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-coptic.js`<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-gregory.js` |
| annexB/built-ins/RegExp | NORMAL | 54.853s | 25 | `test262/test/annexB/built-ins/RegExp/RegExp-control-escape-russian-letter.js`<br>`test262/test/annexB/built-ins/RegExp/RegExp-decimal-escape-class-range.js`<br>...<br>`test262/test/annexB/built-ins/RegExp/legacy-accessors/lastParen/this-cross-realm-constructor.js`<br>`test262/test/annexB/built-ins/RegExp/legacy-accessors/lastParen/this-not-regexp-constructor.js` |
