...
- Snapshot time: `2026-04-27T16:37:12+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `a2bb12c` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47853 | 76 | 2083 | 24 | 907 | 0 | 47929 | 50036 | 50943 | 99.8% |
...
| staging | INCOMPLETE | 1474 | 53 | 93 | 12 | 275 | 0 | 96.5% |
...
| staging/sm | INCOMPLETE | 1284 | 47 | 85 | 12 | 275 | 0 | 96.5% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 75.142s | 6 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>`test262/test/staging/sm/String/string-upper-lower-mapping.js`<br>`test262/test/staging/sm/String/thisv-error.js`<br>`test262/test/staging/sm/String/two-length-nonlatin-indexOf.js`<br>`test262/test/staging/sm/String/unicode-braced.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.709s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.512s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| staging/sm | CRASH | 61.484s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| staging/sm | CRASH | 61.179s | 1 | `test262/test/staging/sm/expressions/nullish-coalescing.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.054s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| language/literals | CRASH | 60.911s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.1_T2.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.841s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.789s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| language/literals | CRASH | 60.767s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.4_T2.js` |
| staging/sm | CRASH | 60.741s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| staging/sm | CRASH | 60.661s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.417s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| staging/sm | CRASH | 60.024s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| language/literals | CRASH | 58.823s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.1_T2.js` |
| language/literals | CRASH | 58.534s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.4_T2.js` |
| intl402 | NORMAL | 54.853s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | OOM | 53.535s | 1 | `test262/test/staging/sm/regress/regress-567152.js` |
| staging/sm | CRASH | 53.393s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
