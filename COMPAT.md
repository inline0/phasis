...
- Snapshot time: `2026-04-25T17:18:51+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `0796a3d` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 48013 | 1462 | 520 | 41 | 1032 | 0 | 49475 | 50036 | 51068 | 97.0% |
...
| staging/sm | INCOMPLETE | 1275 | 133 | 0 | 20 | 275 | 0 | 90.6% |
...
|---|---|---:|---:|---|
| built-ins/decodeURIComponent | NORMAL | 79.859s | 12 | `test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.10_T1.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T3.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T4.js` |
| built-ins/decodeURI | NORMAL | 74.941s | 12 | `test262/test/built-ins/decodeURI/S15.1.3.1_A1.10_T1.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T3.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T4.js` |
| staging/sm | NORMAL | 65.461s | 25 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>...<br>`test262/test/staging/sm/Symbol/property-reflection.js`<br>`test262/test/staging/sm/Symbol/realms.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.912s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.809s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-3-of-8.js` |
| built-ins/Atomics | CRASH | 61.519s | 1 | `test262/test/built-ins/Atomics/waitAsync/poisoned-object-for-timeout-throws-agent.js` |
| staging/sm | CRASH | 61.470s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-5-of-8.js` |
| built-ins/Atomics | CRASH | 61.227s | 1 | `test262/test/built-ins/Atomics/waitAsync/bigint/good-views.js` |
| built-ins/Atomics | CRASH | 61.081s | 1 | `test262/test/built-ins/Atomics/waitAsync/bigint/symbol-for-timeout-throws-agent.js` |
| staging/sm | CRASH | 61.070s | 1 | `test262/test/staging/sm/BigInt/large-bit-length.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.059s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 61.008s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-6-of-8.js` |
| built-ins/Atomics | CRASH | 60.965s | 1 | `test262/test/built-ins/Atomics/waitAsync/symbol-for-timeout-throws-agent.js` |
| built-ins/Atomics | CRASH | 60.953s | 1 | `test262/test/built-ins/Atomics/wait/bigint/waiterlist-order-of-operations-is-fifo.js` |
| built-ins/Atomics | CRASH | 60.895s | 1 | `test262/test/built-ins/Atomics/waitAsync/good-views.js` |
| staging/sm | CRASH | 60.883s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-8-of-8.js` |
| staging/sm | CRASH | 60.845s | 1 | `test262/test/staging/sm/String/fromCodePoint.js` |
| staging/sm | CRASH | 60.842s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| built-ins/Atomics | CRASH | 60.792s | 1 | `test262/test/built-ins/Atomics/wait/waiterlist-order-of-operations-is-fifo.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.638s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
