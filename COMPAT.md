...
- Snapshot time: `2026-05-03T11:29:15+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `cff1be1` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 49558 | 59 | 403 | 16 | 832 | 0 | 49617 | 50036 | 50868 | 99.9% |
...
| built-ins/RegExp | INCOMPLETE | 483 | 3 | 1 | 1 | 25 | 0 | 99.4% |
...
| intl402/NumberFormat | PARTIAL | 250 | 1 | 1 | 0 | 0 | 0 | 99.6% |
...
| staging/sm | INCOMPLETE | 1311 | 23 | 85 | 9 | 225 | 0 | 98.3% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 79.771s | 25 | `test262/test/staging/sm/expressions/destructuring-object-__proto__-2.js`<br>`test262/test/staging/sm/expressions/destructuring-pattern-parenthesized.js`<br>...<br>`test262/test/staging/sm/expressions/string-literal-escape-sequences.js`<br>`test262/test/staging/sm/expressions/tagged-template-constant-folding.js` |
| language/expressions | NORMAL | 69.625s | 25 | `test262/test/language/expressions/call/spread-sngl-iter.js`<br>`test262/test/language/expressions/call/spread-sngl-literal.js`<br>...<br>`test262/test/language/expressions/class/accessor-name-inst/literal-numeric-zero.js`<br>`test262/test/language/expressions/class/accessor-name-inst/literal-string-char-escape.js` |
| language/literals | NORMAL | 65.484s | 25 | `test262/test/language/literals/regexp/7.8.5-2gs.js`<br>`test262/test/language/literals/regexp/S7.8.5_A1.1_T1.js`<br>...<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T1.js`<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T2.js` |
| staging/sm | NORMAL | 64.294s | 2 | `test262/test/staging/sm/TypedArray/sort_modifications.js`<br>`test262/test/staging/sm/TypedArray/sort_small.js` |
| staging/sm | NORMAL | 64.046s | 25 | `test262/test/staging/sm/TypedArray/reduce-and-reduceRight.js`<br>`test262/test/staging/sm/TypedArray/reverse.js`<br>...<br>`test262/test/staging/sm/TypedArray/sort_errors.js`<br>`test262/test/staging/sm/TypedArray/sort_globals.js` |
| staging/sm | NORMAL | 61.834s | 6 | `test262/test/staging/sm/Symbol/toStringTag.js`<br>`test262/test/staging/sm/Symbol/typed-arrays.js`<br>`test262/test/staging/sm/Symbol/typeof.js`<br>`test262/test/staging/sm/Symbol/valueOf.js`<br>`test262/test/staging/sm/Symbol/well-known.js`<br>`test262/test/staging/sm/Temporal/Calendar/compare-to-datetimeformat.js` |
| staging/sm | CRASH | 61.432s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.265s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.202s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| staging/sm | CRASH | 61.142s | 1 | `test262/test/staging/sm/RegExp/unicode-class-braced.js` |
| built-ins/RegExp | CRASH | 60.738s | 1 | `test262/test/built-ins/RegExp/S15.10.2_A1_T1.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 59.877s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| staging/sm | CRASH | 59.810s | 1 | `test262/test/staging/sm/RegExp/unicode-braced.js` |
| staging/sm | CRASH | 59.371s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| intl402 | NORMAL | 53.448s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | NORMAL | 53.292s | 13 | `test262/test/staging/sm/Temporal/PlainDate/from-constrain-hebrew.js`<br>`test262/test/staging/sm/Temporal/PlainDate/from-constrain-japanese.js`<br>...<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-coptic.js`<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-gregory.js` |
| staging/sm | OOM | 50.215s | 1 | `test262/test/staging/sm/regress/regress-567152.js` |
| built-ins/decodeURIComponent | NORMAL | 49.817s | 3 | `test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.12_T1.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.12_T2.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.12_T3.js` |
| built-ins/RegExp/CharacterClassEscapes | NORMAL | 47.691s | 3 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js`<br>`test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-positive-cases.js`<br>`test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-negative-cases.js` |
| built-ins/decodeURI | NORMAL | 47.428s | 3 | `test262/test/built-ins/decodeURI/S15.1.3.1_A1.10_T1.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.11_T1.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.11_T2.js` |
