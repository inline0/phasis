...
- Snapshot time: `2026-04-28T07:50:11+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `23d9fa3` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47849 | 85 | 2083 | 19 | 832 | 0 | 47934 | 50036 | 50868 | 99.8% |
...
| staging | INCOMPLETE | 1477 | 51 | 93 | 11 | 250 | 0 | 96.7% |
...
| staging/sm | INCOMPLETE | 1287 | 45 | 85 | 11 | 250 | 0 | 96.6% |
...
|---|---|---:|---:|---|
| staging/sm | CRASH | 77.799s | 1 | `test262/test/staging/sm/expressions/nullish-coalescing.js` |
| built-ins/decodeURIComponent | NORMAL | 70.384s | 12 | `test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.10_T1.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T3.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T4.js` |
| built-ins/decodeURI | NORMAL | 66.234s | 12 | `test262/test/built-ins/decodeURI/S15.1.3.1_A1.10_T1.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T3.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T4.js` |
| staging/sm | CRASH | 63.985s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| staging/sm | CRASH | 63.678s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| language/literals | NORMAL | 63.120s | 25 | `test262/test/language/literals/regexp/7.8.5-2gs.js`<br>`test262/test/language/literals/regexp/S7.8.5_A1.1_T1.js`<br>...<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T1.js`<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T2.js` |
| staging/sm | NORMAL | 63.060s | 25 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>...<br>`test262/test/staging/sm/Symbol/property-reflection.js`<br>`test262/test/staging/sm/Symbol/realms.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.490s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.416s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.156s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.108s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.064s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 60.907s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.776s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| staging/sm | NORMAL | 54.856s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| staging/sm | CRASH | 54.352s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
| staging/sm | NORMAL | 53.998s | 13 | `test262/test/staging/sm/Temporal/PlainDate/from-constrain-hebrew.js`<br>`test262/test/staging/sm/Temporal/PlainDate/from-constrain-japanese.js`<br>...<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-coptic.js`<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-gregory.js` |
| annexB/built-ins/RegExp | NORMAL | 49.139s | 25 | `test262/test/annexB/built-ins/RegExp/RegExp-control-escape-russian-letter.js`<br>`test262/test/annexB/built-ins/RegExp/RegExp-decimal-escape-class-range.js`<br>...<br>`test262/test/annexB/built-ins/RegExp/legacy-accessors/lastParen/this-cross-realm-constructor.js`<br>`test262/test/annexB/built-ins/RegExp/legacy-accessors/lastParen/this-not-regexp-constructor.js` |
| staging/sm | CRASH | 48.508s | 1 | `test262/test/staging/sm/TypedArray/sort_small.js` |
| staging/sm | CRASH | 46.532s | 1 | `test262/test/staging/sm/Temporal/Calendar/compare-to-datetimeformat.js` |
