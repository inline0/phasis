...
- Snapshot time: `2026-04-25T20:07:54+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `8cd9bf6` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 48113 | 1362 | 520 | 41 | 1057 | 0 | 49475 | 50036 | 51093 | 97.2% |
...
| staging | INCOMPLETE | 1427 | 184 | 1 | 20 | 300 | 0 | 88.6% |
...
| staging/sm | INCOMPLETE | 1278 | 130 | 0 | 20 | 300 | 0 | 90.8% |
...
|---|---|---:|---:|---|
| built-ins/decodeURIComponent | NORMAL | 80.710s | 12 | `test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.10_T1.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T3.js`<br>`test262/test/built-ins/decodeURIComponent/S15.1.3.2_A1.14_T4.js` |
| built-ins/decodeURI | NORMAL | 74.299s | 12 | `test262/test/built-ins/decodeURI/S15.1.3.1_A1.10_T1.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.11_T1.js`<br>...<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T3.js`<br>`test262/test/built-ins/decodeURI/S15.1.3.1_A1.14_T4.js` |
| language/literals | NORMAL | 71.167s | 25 | `test262/test/language/literals/regexp/7.8.5-2gs.js`<br>`test262/test/language/literals/regexp/S7.8.5_A1.1_T1.js`<br>...<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T1.js`<br>`test262/test/language/literals/regexp/S7.8.5_A2.2_T2.js` |
| staging/sm | NORMAL | 67.597s | 12 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>...<br>`test262/test/staging/sm/Symbol/enumeration-order.js`<br>`test262/test/staging/sm/Symbol/enumeration.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.765s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.613s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-8-of-8.js` |
| staging/sm | CRASH | 61.295s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-3-of-8.js` |
| built-ins/Atomics | CRASH | 61.277s | 1 | `test262/test/built-ins/Atomics/wait/bigint/waiterlist-order-of-operations-is-fifo.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.237s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.154s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| staging/sm | CRASH | 61.117s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-4-of-8.js` |
| built-ins/Atomics | CRASH | 61.098s | 1 | `test262/test/built-ins/Atomics/wait/good-views.js` |
| staging/sm | CRASH | 61.048s | 1 | `test262/test/staging/sm/BigInt/large-bit-length.js` |
| built-ins/Atomics | CRASH | 61.030s | 1 | `test262/test/built-ins/Atomics/waitAsync/bigint/poisoned-object-for-timeout-throws-agent.js` |
| staging/sm | CRASH | 60.921s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| staging/sm | CRASH | 60.905s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-5-of-8.js` |
| built-ins/Atomics | CRASH | 60.813s | 1 | `test262/test/built-ins/Atomics/waitAsync/bigint/good-views.js` |
| built-ins/Atomics | CRASH | 60.782s | 1 | `test262/test/built-ins/Atomics/waitAsync/symbol-for-timeout-throws-agent.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.733s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 60.711s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
