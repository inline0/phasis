...
- Snapshot time: `2026-04-27T01:31:51+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `b4cdc3a` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47747 | 182 | 2075 | 32 | 907 | 0 | 47929 | 50036 | 50943 | 99.6% |
...
| staging/sm | INCOMPLETE | 1247 | 84 | 77 | 20 | 275 | 0 | 93.7% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 65.171s | 25 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>...<br>`test262/test/staging/sm/Symbol/property-reflection.js`<br>`test262/test/staging/sm/Symbol/realms.js` |
| intl402 | NORMAL | 63.501s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | CRASH | 62.116s | 1 | `test262/test/staging/sm/expressions/nullish-coalescing.js` |
...
| staging/sm | CRASH | 61.616s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-8-of-8.js` |
| staging/sm | CRASH | 61.406s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| staging/sm | CRASH | 61.327s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-4-of-8.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.151s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| staging/sm | CRASH | 61.108s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| staging/sm | CRASH | 61.089s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.048s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.012s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 60.918s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-6-of-8.js` |
| language/literals | CRASH | 60.830s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.1_T2.js` |
| staging/sm | CRASH | 60.715s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
| language/literals | CRASH | 60.641s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.1_T2.js` |
| staging/sm | CRASH | 60.594s | 1 | `test262/test/staging/sm/BigInt/large-bit-length.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.546s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 60.532s | 1 | `test262/test/staging/sm/Proxy/ownkeys-linear.js` |
| staging/sm | CRASH | 60.509s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-5-of-8.js` |
