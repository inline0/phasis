...
- Snapshot time: `2026-04-27T12:59:35+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `a263191` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47832 | 98 | 2083 | 23 | 882 | 0 | 47930 | 50036 | 50918 | 99.8% |
...
| staging | INCOMPLETE | 1463 | 65 | 93 | 11 | 250 | 0 | 95.7% |
...
| staging/sm | INCOMPLETE | 1273 | 59 | 85 | 11 | 250 | 0 | 95.6% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 69.115s | 6 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>`test262/test/staging/sm/String/string-upper-lower-mapping.js`<br>`test262/test/staging/sm/String/thisv-error.js`<br>`test262/test/staging/sm/String/two-length-nonlatin-indexOf.js`<br>`test262/test/staging/sm/String/unicode-braced.js` |
...
| staging/sm | CRASH | 61.195s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.083s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| staging/sm | CRASH | 60.975s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| staging/sm | CRASH | 60.854s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| language/literals | CRASH | 60.783s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.1_T2.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.683s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.583s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 60.566s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.525s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| language/literals | CRASH | 60.269s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.1_T2.js` |
| language/literals | CRASH | 60.221s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.4_T2.js` |
| staging/sm | CRASH | 60.220s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| language/literals | CRASH | 60.164s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.4_T2.js` |
| intl402 | NORMAL | 57.184s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | NORMAL | 53.899s | 13 | `test262/test/staging/sm/Temporal/PlainDate/from-constrain-hebrew.js`<br>`test262/test/staging/sm/Temporal/PlainDate/from-constrain-japanese.js`<br>...<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-coptic.js`<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-gregory.js` |
| staging/sm | OOM | 53.191s | 1 | `test262/test/staging/sm/regress/regress-567152.js` |
| staging/sm | CRASH | 51.562s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
