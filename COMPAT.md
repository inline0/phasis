...
- Snapshot time: `2026-04-25T18:11:49+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `6acfbe4` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 48063 | 1408 | 520 | 45 | 1107 | 0 | 49471 | 50036 | 51143 | 97.2% |
...
| built-ins | INCOMPLETE | 21940 | 294 | 15 | 21 | 746 | 0 | 98.7% |
...
| built-ins/RegExp/unicodeSets | PARTIAL | 45 | 68 | 0 | 0 | 0 | 0 | 39.8% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 68.263s | 12 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>...<br>`test262/test/staging/sm/Symbol/enumeration-order.js`<br>`test262/test/staging/sm/Symbol/enumeration.js` |
| staging/sm | CRASH | 61.934s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.523s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| built-ins/Atomics | CRASH | 61.443s | 1 | `test262/test/built-ins/Atomics/waitAsync/good-views.js` |
| staging/sm | CRASH | 61.396s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-3-of-8.js` |
| built-ins/Atomics | CRASH | 61.333s | 1 | `test262/test/built-ins/Atomics/notify/notify-in-order.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.269s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.257s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| staging/sm | CRASH | 61.221s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-7-of-8.js` |
| staging/sm | CRASH | 61.218s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-4-of-8.js` |
| staging/sm | CRASH | 61.154s | 1 | `test262/test/staging/sm/String/fromCodePoint.js` |
| staging/sm | CRASH | 61.134s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-1-of-8.js` |
| built-ins/Atomics | CRASH | 61.032s | 1 | `test262/test/built-ins/Atomics/wait/waiterlist-order-of-operations-is-fifo.js` |
| staging/sm | CRASH | 60.947s | 1 | `test262/test/staging/sm/BigInt/large-bit-length.js` |
| staging/sm | CRASH | 60.912s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-6-of-8.js` |
| staging/sm | CRASH | 60.907s | 1 | `test262/test/staging/sm/Date/dst-offset-caching-8-of-8.js` |
| language/literals | CRASH | 60.901s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.4_T2.js` |
| built-ins/Atomics | CRASH | 60.824s | 1 | `test262/test/built-ins/Atomics/wait/good-views.js` |
| staging/sm | CRASH | 60.824s | 1 | `test262/test/staging/sm/Proxy/ownkeys-linear.js` |
| staging/sm | CRASH | 60.779s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
