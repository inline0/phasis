...
- Snapshot time: `2026-04-27T12:40:04+00:00`
- Chunk size: `25`
- Timeout: `300s`
- Jobs: `4`
- Groups: `159`
- Test files: `50506`
- Git: `main` @ `ec45ded` (dirty)

## Summary

| Pass | Fail | Skip | Blocked | Pending | Running | Attempted | Known | Total | Pass Rate |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 47827 | 103 | 2083 | 23 | 907 | 0 | 47930 | 50036 | 50943 | 99.8% |
...
| built-ins | INCOMPLETE | 21174 | 21 | 1067 | 8 | 571 | 0 | 99.9% |
| harness | PASS | 114 | 0 | 2 | 0 | 0 | 0 | 100.0% |
| intl402 | PARTIAL | 1554 | 2 | 10 | 0 | 0 | 0 | 99.9% |
| language | INCOMPLETE | 22458 | 9 | 902 | 4 | 61 | 0 | 100.0% |
| staging | INCOMPLETE | 1458 | 70 | 93 | 11 | 275 | 0 | 95.4% |
...
| built-ins/ShadowRealm | PARTIAL | 57 | 4 | 3 | 0 | 0 | 0 | 93.4% |
...
| staging/sm | INCOMPLETE | 1268 | 64 | 85 | 11 | 275 | 0 | 95.2% |
...
|---|---|---:|---:|---|
| staging/sm | NORMAL | 65.253s | 6 | `test262/test/staging/sm/String/string-pad-start-end.js`<br>`test262/test/staging/sm/String/string-space-trim.js`<br>`test262/test/staging/sm/String/string-upper-lower-mapping.js`<br>`test262/test/staging/sm/String/thisv-error.js`<br>`test262/test/staging/sm/String/two-length-nonlatin-indexOf.js`<br>`test262/test/staging/sm/String/unicode-braced.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 62.164s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-word-class-escape-negative-cases.js` |
| staging/sm | CRASH | 61.892s | 1 | `test262/test/staging/sm/TypedArray/sort_large_countingsort.js` |
| staging/sm | CRASH | 61.337s | 1 | `test262/test/staging/sm/TypedArray/sort_modifications.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 61.200s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-whitespace-class-escape-positive-cases.js` |
| language/literals | CRASH | 61.089s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.4_T2.js` |
| staging/sm | CRASH | 61.011s | 1 | `test262/test/staging/sm/TypedArray/set-same-buffer-different-source-target-types.js` |
| staging/sm | CRASH | 60.970s | 1 | `test262/test/staging/sm/BigInt/large-bit-length.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.848s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-non-digit-class-escape-positive-cases.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.830s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-whitespace-class-escape-negative-cases.js` |
| language/literals | CRASH | 60.748s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.1_T2.js` |
| language/literals | CRASH | 60.695s | 1 | `test262/test/language/literals/regexp/S7.8.5_A2.4_T2.js` |
| staging/sm | CRASH | 60.631s | 1 | `test262/test/staging/sm/Array/toSpliced-dense.js` |
| staging/sm | CRASH | 60.545s | 1 | `test262/test/staging/sm/expressions/nullish-coalescing.js` |
| built-ins/RegExp/CharacterClassEscapes | CRASH | 60.514s | 1 | `test262/test/built-ins/RegExp/CharacterClassEscapes/character-class-digit-class-escape-negative-cases.js` |
| staging/sm | CRASH | 59.612s | 1 | `test262/test/staging/sm/regress/regress-1507322-deep-weakmap.js` |
| language/literals | CRASH | 59.306s | 1 | `test262/test/language/literals/regexp/S7.8.5_A1.1_T2.js` |
| intl402 | NORMAL | 56.618s | 22 | `test262/test/intl402/constructors-string-and-single-element-array.js`<br>`test262/test/intl402/constructors-taint-Object-prototype-2.js`<br>...<br>`test262/test/intl402/supportedLocalesOf-throws-if-element-not-string-or-object.js`<br>`test262/test/intl402/supportedLocalesOf-unicode-extensions-ignored.js` |
| staging/sm | CRASH | 55.170s | 1 | `test262/test/staging/sm/TypedArray/element-setting-converts-using-ToNumber.js` |
| staging/sm | NORMAL | 53.419s | 13 | `test262/test/staging/sm/Temporal/PlainDate/from-constrain-hebrew.js`<br>`test262/test/staging/sm/Temporal/PlainDate/from-constrain-japanese.js`<br>...<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-coptic.js`<br>`test262/test/staging/sm/Temporal/PlainMonthDay/from-gregory.js` |
